...
output_file = "jessica_moods.jsonl"

with open('character_state.schema.json', 'r') as file:
    character_state_schema = file.read()

system = "You generate moods for a fictional character, your output must be purely JSON with no commentary, conforming to the following schema:\n" + character_state_schema
